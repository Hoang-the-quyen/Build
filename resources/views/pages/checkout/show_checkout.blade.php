		...
		<div class="container">
			<div class="breadcrumbs">
				<ol class="breadcrumb">
				  ...
				  <li class="active">Thông tin người nhận vật tư</li>
				</ol>
			</div>
				...
				<div class="row">
					...
					<div class="col-sm-12 clearfix">
						<div class="bill-to">
							...
							<div style="width:100%;text-align:center" class="form-one">
								<form action="{{URL::to('/save_checkout_customer')}}" method="post">
									...
									<div class="order-message">
										<textarea style="height: 251px" name="shipping_note"  placeholder="Ghi chú đơn hàng"  rows="16"></textarea>
									</div>
									<input style="background-color: green;color:aliceblue;font-size:20px;width:20%;" type="submit" value="Gửi" name="send_order" class="btn btn-default btn-sm">
								</form>
							</div>
			...
			<div class="review-payment">
				<h2 style="margin-bottom: 50px">Hình thức thanh toán</h2>
			</div>
